...
class GeneralCompletionsProvider {
  ...
  async enable() {
    console.log("enabling general completions");
  ...
  disable() {
    console.log("disabling general completions");
    this.subscriptions.dispose();
  }

  dispose() {
    console.log("disposing of general completions");
    this.subscriptions.dispose();
  }
  ...
  async regenerateUserCompletions() {
    console.log("regenerating user completions");
