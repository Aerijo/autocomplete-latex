...
module.exports = {
  ...
  mergeObjects(first, second) {
    ...
    if (clashes.length > 0) {
      ...
      atom.notifications.addWarning("\`autocomplete-latex\` The following completions conflict with the defaults and have been ignored:", {dismissable: true, detail: prettyPrint});
    }
    return merged;
  },
