        ...
        for (let typeKey in second[scopeKey]) {
          if (typeKey in first[scopeKey]) {
            for (let i = 0; i < second[scopeKey][typeKey].length; i++) {
              let firstDisplay = first[scopeKey][typeKey][i].displayText || first[scopeKey][typeKey][i].prefix;
              let secondDisplay = second[scopeKey][typeKey][i].displayText || first[scopeKey][typeKey][i].prefix;
