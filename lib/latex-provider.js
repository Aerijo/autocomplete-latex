  ...
  */
  ...
  loadProperties() {
      ...
      try {
        ...
        */
        if (Object.getOwnPropertyNames(userCompletions)[0][0] === ".") {
          ...
          this.completionRegistry.addCompletionGroup(userCompletions, {}); // needs work / {} means no packages have been disabled/enabled
        }
      }
      catch (err) {
    ...
    if (atom.config.get("autocomplete-latex.enableDefaultCompletions")) {
      ...
      this.completionRegistry.addCompletionGroup(defaultCompletions, this.enabledPackagesList);
    }
